...
3. **URL Format**: `https://docs-mdx-assets-sandbox.s3.ap-south-1.amazonaws.com/latest/{path-to-asset}`
...
- **Final URL**: `https://docs-mdx-assets-sandbox.s3.ap-south-1.amazonaws.com/latest/data/account-aggregator/consent-object-flow.png`
...
```mdx
<MainImage
    src="https://docs-mdx-assets-sandbox.s3.ap-south-1.amazonaws.com/latest/data/account-aggregator/your-image.png"
