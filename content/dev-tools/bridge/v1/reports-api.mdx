...
<table>
  <tbody>
    <tr>
      <th>URL</th>
      <td>
        <code>https://bifrost.setu.co/bifrost/collect/reports</code>
      </td>
    </tr>
    <tr>
      <th>Method</th>
    ...
    <tr>
      ...
      <td>
        ...
        <br />
        <br />
        <code>Authorization</code>: Bearer <strong>insert_token_here</strong>. Read about how to generate this token <a href="resources/generate-token" target="_blank">here</a>.
        <br />
      </td>
    </tr>
  </tbody>
