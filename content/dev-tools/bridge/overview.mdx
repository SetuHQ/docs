...
<img src="https://docs-assets.setu.co/latest/bridge-v2-docs/Overview/Home.png" alt="Bridge home" />
...
5. <ins>Provide your business name.</ins> This should belong to the business you’re setting up the Bridge account for. <strong>Quick note:</strong> You can use a different business name later when you configure the product (say, if you have a subsidiary or a different legal name).
...
<img src="https://docs-assets.setu.co/latest/bridge-v2-docs/Overview/Sign%20up.gif" alt="Sign up on the bridge" />
...
<img src="https://docs-assets.setu.co/latest/bridge-v2-docs/Overview/Login.gif" alt="Login into the bridge" />

### Navigating Bridge

<img src="https://docs-assets.setu.co/latest/bridge-v2-docs/Overview/navigating-bridge.gif" alt="Sidebar navigation" /> 

##### Side navigation items
Explore the different sections on the Bridge sidebar.

<img src="https://docs-assets.setu.co/latest/bridge-v2-docs/Overview/Side%20nav.gif" alt="Bridge side navigation items" />
...
<img src="https://docs-assets.setu.co/latest/bridge-v2-docs/Overview/Profile.gif" alt="User profile on the bridge" />
