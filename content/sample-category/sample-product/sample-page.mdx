...
<MainImage
  src="https://docs-mdx-assets-sandbox.s3.ap-south-1.amazonaws.com/latest/Screenshot_2021_03_19_at_3_39_31_PM_ccd1f16be5/Screenshot_2021_03_19_at_3_39_31_PM_ccd1f16be5.png"
  alt="Bridge"
/>
...
<Tabs
  ...
  <details open>
    <summary>
                <Text size="medium" marginBottom="none" paddingRight="medium"><Badge type="success">SUCCESS</Badge> Description 1</Text>
    </summary>
...
{ 
  ...
  <details>
    <summary>
                <Text size="medium" marginBottom="none" paddingRight="medium"><Badge type="success">SUCCESS</Badge> Description 2</Text>
    </summary>
              <hr className="tertiary" />
              <h5>Request</h5>
              <CodeBlockWithCopy language="json">
...
{ 
  ...
  <details>
    <summary>
                <Text size="medium" marginBottom="none" paddingRight="medium"><Badge type="failure">FAILURE</Badge> Failure 1</Text>
    </summary>
              <hr className="tertiary" />
              <h5>Request</h5>
              <CodeBlockWithCopy language="json">
...
{ 
  ...
  <details>
    <summary>
                <Text size="medium" marginBottom="none" paddingRight="medium"><Badge type="failure">FAILURE</Badge> Failure 2</Text>
    </summary>
              <hr className="tertiary" />
              <h5>Request</h5>
              <CodeBlockWithCopy language="json">
