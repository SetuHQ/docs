...
- **Fetch Aadhaar data**—Fetch Aadhaar document data in JSON format as well as an XML file. The API aids in carrying out Aadhaar KYC using DigiLocker.
...
<Row>
  <Portion desktopSpan="half">
    <img src="https://docs-mdx-assets-sandbox.s3.ap-south-1.amazonaws.com/latest/digilocker_auth_flow_c84910dbf3/digilocker_auth_flow_c84910dbf3.png" />
  </Portion>
</Row>
