    ...
    "validUpto": "2021-10-06T08:43:18+05:30" 
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                <Badge type="failure">BAD REQUEST</Badge> The DigiLocker request
                has expired.
              </p>
              <hr className="tertiary" />
              <h5>Request</h5>
    ...
    "error": { 
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                <Badge type="failure">BAD REQUEST</Badge> User not authenticated
              </p>
              <hr className="tertiary" />
              <h5>Request</h5>
              <CodeBlockWithCopy language="json">
    ...
    "error": {
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                <Badge type="failure">BAD REQUEST</Badge> User token has been
    ...
    "error": { 
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                <Badge type="failure">BAD REQUEST</Badge> Failed to get user's Aadhaar XML.
              </p>
              <hr className="tertiary" />
              <h5>Request</h5>
              <p>
