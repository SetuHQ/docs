...
4. **You fetch configured outputs** using that `reportId` - see [Outputs](#outputs) below.
...
**Fetch via API.** Pass the `reportId` to the <a href="/data/signal-iq/output-apis" target="_blank">API reference</a> endpoints for the format you need. You can re-fetch anytime for reconciliation.
