...
**Fetch via API.** Pass the `reportId` to the <a href="/data/signal-iq/siq-api/api-reference" target="_blank">API reference</a> endpoints for the format you need. You can re-fetch anytime for reconciliation.
