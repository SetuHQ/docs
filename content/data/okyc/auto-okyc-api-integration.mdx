---
sidebar_title: AUTO-OKYC API Integration
page_title: Offline Aadhar API integration
order: 4
                    ...
                    content: (
                        <>
                            <p>
                                ...
                                request has been processed successfully and a
                                new AUTO-OKYC request has been created.
                            </p>
                            ...
                            <h5>Response</h5>
                            <p>
                                Use the request <code>id</code> in this response
                    ...
                    content: (
                        <>
                            <p>
                                ...
                                Setu has failed to process your request due to
                                some error in code or an unreachable database;
                                or because authentication services are down.
                            </p>
                            <hr className="tertiary" />
                            <h5>Request</h5>
                            <CodeBlockWithCopy language="json">
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                <Badge type="failure">INVALID SEQUENCE</Badge> This API has been called in incorrect sequence, either—
                <ul><li><em><strong>Before</strong></em> calling the <strong>Initiate AUTO-OKYC request</strong> API with this request <code>id</code> . Call the <strong>Initiate AUTO-OKYC request</strong> API to proceed.</li><li>Or <em><strong>after</strong></em> the <code>status</code> associated with request <code>id</code> is <code>complete</code>, i.e, this request has already been completed. This also means that the Aadhaar number provided with this request <code>id</code> is already processed and is confirmed as either verified or incorrect.  You should instead call the <strong>Get AUTO-OKYC request status</strong> API to proceed.</li></ul>
              </p>
              <hr className="tertiary" />
              <h5>Request</h5>
              <CodeBlockWithCopy language="json">
...
<Callout type="warning">
    ...
    <strong>Complete AUTO-OKYC request</strong> API with a correct <code>otp</code>{" "}
...
<Row>
  ...
  "aadhaar": { 
    ...
    "id": "7097e53a-ba29-48a2-983d-878433b4f33e", 
    "status": "incomplete", 
    "validUpto": "Fri, 10 Sep 2021 20:11:17 GMT" 
} `}
              </CodeBlockWithCopy>
            </>
          ),
