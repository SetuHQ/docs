                    ...
                    content: (
                        <>
                            <p>
                                ...
                                new OKYC request has been created.
                            </p>
...
<Callout type="tip">
    ...
    success and 773032249986 for an Aadhaar that does not have a linked mobile
    number. Any other value for Aadhaar will be considered invalid. Use 2GAD0
    for valid captcha and any other value for invalid.
</Callout>
