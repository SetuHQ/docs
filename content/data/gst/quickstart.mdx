      ...
      content: (
        <>
          <p>
            ...
            <code>gstin</code> and Setu has processed your request successfully.
          </p>
      ...
      content: (
        <>
          <p>
            ...
            request successfully, the gsin {" "} is valid and has additional address. 
            <code>gstin</code>
          </p>
          <hr className="tertiary" />
          <h5>Request</h5>
      ...
      content: (
        <>
          <p>
            ...
            The request failed due to error at upstream provider
          </p>
          <hr className="tertiary" />
          <h5>Request</h5>
          <CodeBlockWithCopy language="json">
