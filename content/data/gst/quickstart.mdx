      ...
      tabs={[
        {
          ...
          content: (
            <>
            <Text size="small" weight="600">Type 1 (open by default)</Text>
            <Card padding="nano" shape="rounded" marginBottom="micro">
  <details>
    <summary>
                <Text size="medium" marginBottom="none" paddingRight="medium"><Badge type="success">SUCCESS</Badge> Your
                                    request has a valid <code>gstin</code> and
...
{ 
  ...
  <details>
    <summary>
                <Text size="medium" marginBottom="none" paddingRight="medium"><Badge type="success">SUCCESS</Badge> Setu
                                    has processed your request successfully, the{" "}
                                    <code>gstin</code> is valid and has
...
{ 
  ...
  <details>
    <summary>
                <Text size="medium" marginBottom="none" paddingRight="medium"><Badge type="success">SUCCESS</Badge> Setu
                                    has processed your request successfully, but
                                    the request has an invalid{" "}
                                    <code>gstin</code></Text>
    </summary>
              <hr className="tertiary" />
              <h5>Request</h5>
              <CodeBlockWithCopy language="json">
...
{ 
  ...
  <details>
    <summary>
                <Text size="medium" marginBottom="none" paddingRight="medium"><Badge type="failure">ERROR</Badge> The
                                    request failed due to an error at our
