...
Call this API to generate an Insight report from a list of FI data blocks, using a template configured for the user.
  ...
  tabs={[
    {
      ...
      content: (
        <>
          <p>
            A <code>reportId</code> is returned along with the status of the Insights generation job.
            The <code>reportId</code> can be used to get insights. A notification will be posted after successful generation of insights.
          </p>
          <CodeBlockWithCopy language="json">
            {`{
  "status": "Success",
...
Call this API to get the generated insights under the report.
