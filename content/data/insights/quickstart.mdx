...
You can delete a customer’s data from Setu using the `refId` via `/v2/purge` API. Useful for compliance and data minimization needs. See the <a href="/data/insights/quickstart/api-integration">API Integration</a> section for details.
