...
Once you have the financial data of a user, you can feed this data into Setu Insights with a customer reference id. Use a single `refId` for an individual customer use case. Refer <a href="/data/insights/quickstart/api-integration" target="_blank">API integration</a> to integrate with Data ingestion APIs.
