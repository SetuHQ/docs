...
Read up more about the the `Consent configurations` <a href="/data/account-aggregator/consent-object" target="_blank">here</a>.
...
<Row>
  ...
  {`{
    ...
    "url": "https://fiu-uat.setu.co/consents/v2/webview/60c76fa3-601c-4b9d-ad30-d33c0ebcacf3",
    "status": "PENDING",
    "Detail": {
...
<Row>
  ...
  {`{
    ...
    "traceId": "26b8bc4c-5d33-43a1-a58f-be5d4d0acbd0"
                            ...
                            <p> If query param <code>expanded=true</code> is included in the request</p>
                            <CodeBlockWithCopy language="json">
  {`{
    ...
    "Detail": {
        ...
        "consentStart": "2023-03-30T12:09:39.557Z",
        "DataLife": {
            "unit": "MONTH",
            "value": 1.0
        },
    ...
    "traceId": "1-642bca7b-2009609f266ad58459976e64"
}
}`}
</CodeBlockWithCopy>
                        </>
