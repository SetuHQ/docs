...
1.  **Create Consent Request**—this is essentially a one-time data request that your user needs to approve. To know more details about this please visit [Consent Configurations](/data/account-aggregator/api-integration/consent-configurations) page.
