...
<Callout type="warning">
    Currently, the dual consent feature supports merging two consent requests.
    For more complex scenarios, consider additional consent requests as separate
    flows.
</Callout>
...
<Callout type="tip">
    <strong>
        At least one consent must be marked as mandatory to initiate the dual
        consent process.
    </strong>
</Callout>
