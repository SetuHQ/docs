...
1.  **Create Consent Request**—this is essentially a one-time data request that your user needs to approve. The consent request has some [`Consent Confifurations`](%28/data/account-aggregator/consent-configurations%29) which specifies details around—
    - the data you’ve requested for
    - the purpose of requesting the data
    - the frequency of data fetch

- Once a consent is created, you will receive a unique `id` with status = `PENDING`, along with a `url` where you can **redirect your customer to consent manager screens**, to review the data request. Here, the user may approve or reject the request. Read more about Consent Manager [here.](https://staging.docs.setu.co/data/account-aggregator/consent-manager)
...
<CodeBlockWithCopy language="json">
  {`{
    "url": "https://fiu-uat.setu.co/v2/consents/webview/73633c01-d14d-4dbb-8a82-d82e53df5920",
    "status": "PENDING",
    "context": [],
    "vua": "8951238048@onemoney",
    "consentStart": "2023-05-22T07:39:41.333Z",
    "consentExpiry": "2023-09-19T13:09:41.333Z",
    "traceId": "060d38c4-2fb9-4a43-9e60-72a81ba57c8f"
}
}`}
</CodeBlockWithCopy>
