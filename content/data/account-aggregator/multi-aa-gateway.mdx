...
<MainImage
  src="https://storage.googleapis.com/strapi-assets/tsp-multi-aa/tsp-multi-aa.png"
...
By routing consent requests to the most performant AA, the Multi-AA Gateway increases the likelihood of successful consent completion, reducing failure rates and improving overall conversion rates.
...
In future phases, FIUs will be able to prioritize certain AAs based on business needs, allowing more granular control over the consent routing process.

###### 5. Simple integration
APIs are standardized across all AAs, ensuring seamless integration with Setu’s TSP (Third-Party Service Providers), making it easier for FIUs to manage consent workflows without worrying about AA-specific API integrations.

All data from AAs are always shared in the standardised format specified by ReBIT.  
