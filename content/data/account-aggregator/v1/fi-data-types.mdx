...
1. Call Create Consent Request [API](https://staging.docs.setu.co/data/account-aggregator/api-integration/consent-flow)
...
4. Create a [Data Session](https://staging.docs.setu.co/data/account-aggregator/api-integration/data-apis#create-new-data-session-api) for the approved consent<br/>
   - _Setu FIP prepares the data as per your consent request_<br/>
5. Call [Fetch FI Data](https://staging.docs.setu.co/data/account-aggregator/api-integration/data-apis#create-new-data-session-api) and get Deposit FI data from Setu FIP<br/>
