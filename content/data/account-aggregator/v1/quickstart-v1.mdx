...
The following flowchart gives a quick snapshot of how the overall API flow works. The steps marked in <span style={{ color: "white", backgroundColor: "#1482FF", width: "30px", borderRadius: "4px", padding: "4px", fontFamily: "Monospace" }}><strong>blue</strong></span> are the API calls you need to make—
