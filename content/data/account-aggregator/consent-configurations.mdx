...
Consent Configurations are the core of the AA framework.

Consent Configurations carry information about all the different types of data the FIU needs, the purpose of the data, and how the FIU plans to use the data and so on. All parameters described below can be configured on the <a href="https://bridge.setu.co/signup" target="_blank"> Bridge</a>
...
<Callout type type="highlight">
Few parameters are required to be specified for the creation of a consent. Some of these parameters can be set on bridge (<strong>Consent configuration</strong>)
and if required , can be overriden during consent creation. Some other configurations have to be passed in the request body during consent creation (<strong>Consent Request object</strong>).
</Callout>
<br />
