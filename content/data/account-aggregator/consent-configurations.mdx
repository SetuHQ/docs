...
Few parameters are required to be specified for the creation of a consent. Some of these parameters can be set on bridge(Consent configuration)
and if required , can be overriden during consent creation. Some other configurations have to be passed in the request body during consent creation(Consent Request object).
</Callout>
<br />
