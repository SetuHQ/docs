...
<Callout type="tip">
    Request to enable validation of customer name and birth year by writing to
    us at{" "}
    <a href="https://setu.co/support" target="_blank">
        Setu Support
    </a>
    . Also specify threshold of fuzzy match for name.
</Callout>
            ...
            tabs={[
                {
                    ...
                    content: (
                        <>
                            <p>
                                <Badge type="success">SUCCESS</Badge> Signature
                                request is in <code>sign_complete</code> state
                                and available for download.
                            </p>
                            <hr className="tertiary" />
                            <h5>Request</h5>
                            <p>
                                Pass the signature request <code>id</code> as a
                                URL parameter
                            </p>
                            <CodeBlockWithCopy language="json">
                    ...
                    content: (
                        <>
                            <p>
                                ...
                                Signature request is not yet completed.
                            </p>
                            <hr className="tertiary" />
                            <h5>Request</h5>
                            <p>
                    ...
                    content: (
                        <>
                            <p>
                                ...
                                signed document is either deleted or an
                                incorrect signature request <code>id</code> has
                                been provided.
                            </p>
                            <hr className="tertiary" />
                            <h5>Request</h5>
            ...
            tabs={[
                {
                    ...
                    content: (
                        <>
                            <p>
                                <Badge type="success">SUCCESS</Badge> You will
                                get a success 204 status post deletion.
                            </p>
                            <hr className="tertiary" />
                            <h5>Request</h5>
                            <p>
                ...
                },
                {
                    ...
                    content: (
                        <>
                            <p>
                                <Badge type="failure">NOT FOUND</Badge> When the
                                provided signature request <code>id</code> is
                                incorrect.
                            </p>
                            <hr className="tertiary" />
                            <h5>Request</h5>
