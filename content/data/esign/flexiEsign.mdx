...
<p>
  The signing config is a JSON that specifies on which pages and at what
  coordinates the specific
  <br />
...
<Callout type="tip">
  ...
  1.
  <br />
  Signer 2 signs at <code>(x1:402, y1: 53, x2: 542, y2:93)</code> on pages 2 and
  3.
</Callout>
          ...
          content: (
            <>
              ...
              <p>
                ...
                <br />
                Remove line breaks from the JSON before uploading. <a hef="https://www.textfixer.com/tools/remove-line-breaks.php">
                  (remove line break)
                </a>—
                <br />
              </p>
              ...
              <ul>
                <li>
                  Unique configId <code>id</code> which can be used to create
                  signature request.
                </li>
                <li>
                  The same comfigId can be used across multiple signature
