          ...
          content: (
            <>
              ...
              <p>
                ...
                <br />
                The request body should be a continuos string. To achieve that, remove line breaks from the JSON before uploading. <a href="https://www.textfixer.com/tools/remove-line-breaks.php" target="_blank">
                  (remove line break)
                </a>
                <br />
              </p>
