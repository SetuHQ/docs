---
sidebar_title: Pdf templating guide
...
4. **Get template**-get template doc and form fields with the template `id`. 
...
files= [ 
  ("document", ("aof.pdf", open("/Users/path/Aof.pdf", "rb"), "application/pdf")) 
              ...
              <p>
                ...
                <code>temaplateId</code> from Setu for render template/signature request
                creation.
              </p>
              <CodeBlockWithCopy language="json">
                {` {
...
<Callout type="tip">Render template functtionality can also be clubbed up with create signature request.</Callout>
      ...
      tabs={[
        {
          ...
          content: (
            <>
            <Text size="small" weight="600">Create request using documentId (you can also use configId)</Text>
              <p>
                <Badge type="success">SUCCESS</Badge> Setu has processed your
                request successfully.
              </p>
        ...
        },
        {
          ...
          content: (
            <>
            <Text size="small" weight="600">Create request using templateId and form fields.</Text>
              <p>
                <Badge type="success">SUCCESS</Badge> Setu has processed your
      ...
      tabs={[
        {
          ...
          content: (
            <>
              ...
              <h5>Request</h5>
              <p>
                Pass the template <code>id</code> and <code>version No</code> as a URL parameter.
              </p>
              <CodeBlockWithCopy language="json">
