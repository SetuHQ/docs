...
page_title: Quickstart for Validate UPI VPA
order: 1
...
The following guide describes a sync API implementation for validating UPI VPA.
            ...
            <>
              <>
                ...
                <Card padding="nano" shape="rounded" marginBottom="micro">
                  <details>
                    <summary>
                      <Badge type="success">SUCCESS</Badge> Your request has a
                      valid <code>VPA</code> and Setu has processed your request
                      successfully.
                    </summary>
                ...
                <Card padding="nano" shape="rounded" marginBottom="micro">
                  <details>
                    <summary>
                      ...
                      your request successfully but the request has an invalid{" "}
                      <code>VPA</code>.
                    </summary>
                    <hr className="tertiary" />
                    <h5>Request</h5>
    ...
    "traceId": "061b26e1-cb3c-4373-a761-ad03d6251f04"
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                <Badge type="failure">BAD REQUEST</Badge> Your request contents
                invalid <code>VPA</code> format
              </p>
              <hr className="tertiary" />
              <h5>Request</h5>
              <CodeBlockWithCopy language="json">
    ...
    "error": {
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                <Badge type="failure">INTERNAL SERVER ERROR</Badge>Setu’s system has failed to process your request due to some internal error or upstream error.
              </p>
              <hr className="tertiary" />
              <h5>Request</h5>
              <CodeBlockWithCopy language="json">
