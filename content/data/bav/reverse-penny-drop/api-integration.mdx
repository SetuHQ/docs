...
<Callout type="tip">
    To get started quickly, you can setup a mock API endpoint using <a href="https://beeceptor.com/" target="_blank">Beeceptor</a>. 
...
<Callout type="warning">
  You can expect this `additionalData` as part of a JSON body when we will notify
  you bank account verification details over webhook, or when you use our <code>GET</code> details API.
</Callout>
<br />
      ...
      tabs={[
        {
          ...
          content: (
            <>
              <p>
                <Badge type="success">CREATED</Badge> RPD request created.
              </p>
 ...
 
{
 ...
 `}
    ...
    "validUpto": "2023-03-13T13:20:52.277688"
              ...
              <Callout type="tip">
                Note: This 'id' is your 'requestId'. Please use this 'requestId'
                for rest the API reference.
              </Callout>
            </>
          ),
        },
        {
          ...
          content: (
            <>
              <p>
                <Badge type="failure">BAD REQUEST</Badge> additionalData should be simple key-value pairs (string value only)
              </p>
              <hr className="tertiary" />
              <h5>Request</h5>
              <CodeBlockWithCopy language="json">
    ...
    "error": {
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                <Badge type="failure">INTERNAL SERVER ERROR</Badge> Internal
                service error or upstream service failure while processing
                request
              </p>
              <hr className="tertiary" />
              <h5>Request</h5>
      ...
      tabs={[
        {
          ...
          content: (
            <>
              <p>
                <Badge type="success">SUCCSS</Badge> Successfully Mocked. If
                you already configured webhook url, you should receive a
                successful webhook now.
              </p>
              <hr className="tertiary" />
              <h5>Request</h5>
              <CodeBlockWithCopy language="json">
...
<Callout type="tip">
  If the bank account is classified as PPI, then it is for sure a PPI instrument
  and for majority of the use cases consider it an invalid bank account since
  money movement doesn't happen when trying to deposit an amount through
  IMPS/NEFT/RTGS. There can be PPI instruments which come up as `UNKNOWN`,
...
<Callout type="tip">
  ...
  example: if you're not receiving successful webhook for a customer and want to
  know if the customer has made the INR 1 payment for bank verification or not.
</Callout>
      ...
      tabs={[
        {
          ...
          content: (
            <>
              <>
                <p>
                  <Badge type="success">Success</Badge> Bank verification status and bank details (if available).
                </p>
                <hr className="tertiary" />
                <h5>Request</h5>
                <CodeBlockWithCopy language="json">
    ...
    "additionalData": {
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                <Badge type="failure">NOT FOUND</Badge> Request id not found.
              </p>
              <hr className="tertiary" />
              <h5>Request</h5>
              <CodeBlockWithCopy language="json">
