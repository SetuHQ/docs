...
<Callout type="warning">
    You can expect this `additionalData` as part of a JSON body when we will
    notify you bank account verification details over webhook, or when you use
    our <code>GET</code> details API.
</Callout>
<br />
