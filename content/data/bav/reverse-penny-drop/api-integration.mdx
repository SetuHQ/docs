...
_`bankAccountType` is a optional data field, you may not receive the value always. (Please contact with Setu team to know more about this feature.)_
_The value can be `SAVINGS`, `CURRENT`, `JOINT`, `NRO`, `NRE`_
