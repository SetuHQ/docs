...
page_title: Quickstart for Penny less drop
order: 1
visible_in_sidebar: false
---

## Bank account verification using Penny less drop API

The following guide describes a sync API implementation for Penny less drop API.
