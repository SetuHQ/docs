...
page_title: Quickstart for PennyLess
order: 1
visible_in_sidebar: false
---

## Bank account verification using PennyLess API

The following guide describes a sync API implementation for PennyLess API.
