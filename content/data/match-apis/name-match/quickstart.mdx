---
sidebar_title: Name Match Quickstart
...
payload= { 
    ...
    "traceId": "1-6690d779-00bd76895fc117162acba45f"
              ...
              <table>
                ...
                <br></br>
                <p>To get started, you can set a threshold between 70% and 75% when testing the API, and adjust the threshold according to your preference. You can also directly consume the match type.</p>
            </>
          ),
        },
        {
