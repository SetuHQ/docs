...
You can refer our document on the [tools enabled on the MCP server](./payments/billpay/mcp/tools-and-prompts) and the [prompts](./payments/billpay/mcp/tools-and-prompts#sample-prompts) you can use to use them.