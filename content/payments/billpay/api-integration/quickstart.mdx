...
Once you have received your API keys and agent ID for testing, you can start integrating with our APIs. Begin with the <a href="/payments/billpay/api-integration/paying_bills" target="_blank">Paying Bills Integration Guide</a> which covers the 3 core payment flows:
