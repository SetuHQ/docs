...
<p>
  ...
  if needed. Contact us at <a href="">support@setu.co</a>, should you
...
| Event type              | Path                       |
| ----------------------- | -------------------------- |
| `fetch` a bill          | `/bills/fetch/request/`    |
| `validate` bill details | `/bills/validate/request/` |
| `payment` of bill       | `/bills/payment/request/`  |
| `dispute` against bill  | `/bills/dispute/request/`  |
...
<Callout type="tip">
    ...
    <br />
    <br />
    In case you specify a path, it will get appended to the <code>
        callbackURL
    </code> value. If you specify a URL, it will simply override the callback URL
    value for that particular event.
</Callout>
&nbsp;
