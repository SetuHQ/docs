...
**Scope**: This guide covers using Setu APIs to pay bills through the BBPS (Bharat Bill Payment System) network. For prepaid mobile recharge, refer to the separate <a href="/payments/billpay/mobile-prepaid-recharge">prepaid recharge API documentation</a>.
...
📖 **Complete NPCI formats and examples → <a href="/payments/billpay/api-integration/paying-bills/remittance_flows_guide" target="_blank">Remitter Details Guide</a>**
...
📖 **Complete CCF implementation → <a href="/payments/billpay/api-integration/paying-bills/customer-convenience-fee" target="_blank">Customer Convenience Fee Guide</a>**
...
📖 **Complete implementation → <a href="/payments/billpay/api-integration/paying-bills/bill-payment-options" target="_blank">Paying for alternative options</a>**
...
📖 **Complete multi-bill implementation → <a href="/payments/billpay/api-integration/paying-bills/multi-bill-processing" target="_blank">Multi-Bill Processing Guide</a>**
...
📖 **Complete plan selection implementation → <a href="/payments/billpay/api-integration/paying-bills/plan-mdm-integration" target="_blank">Paying for plans</a>**
...
- <a href="/payments/billpay/api-integration/paying-bills/bill-payment-options" target="_blank">Paying for alternative options</a> — Handle multiple payment amounts 
- <a href="/payments/billpay/api-integration/paying-bills/plan-mdm-integration" target="_blank">Plan MDM Integration</a> — Plan-based biller patterns
- <a href="/payments/billpay/api-integration/paying-bills/multi-bill-processing" target="_blank">Multi-Bill Processing Guide</a> — Multiple bills handling 
- <a href="/payments/billpay/api-integration/paying-bills/remittance_flows_guide" target="_blank">Remitter Details Guide</a> — Payment format specifications  
