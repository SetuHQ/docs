...
📖 **This extends <a href="/payments/billpay/api-integration/paying-bills/quickstart#4-flow-2-bill-validation--payment" target="_blank">Flow 2: Bill Validation → Payment</a> from the master guide**
...
→ Use standard <a href="/payments/billpay/api-integration/paying-bills/quickstart#4-flow-2-bill-validation--payment" target="_blank">Bill Validation flow</a>
...
<Callout type="tip">
<b>Note:</b> If a biller uses a different parameter name for plan ID, check that biller's specification from List Billers API.
</Callout>
<br />
...
<Callout type="tip">
 <b>💰 Amount Format:</b> All amounts must be specified in <b>paise</b> (1 Rupee = 100 paise) and must match the selected plan's amount exactly.
</Callout>
<br />
