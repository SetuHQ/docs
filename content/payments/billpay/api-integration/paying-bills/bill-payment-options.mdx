...
- **Master guide**: Flow 1 implementation details → <a href="/payments/billpay/api-integration/paying-bills/quickstart#3-flow-1-bill-fetch--payment" target="_blank">Paying Bills</a>
...
- **Real‑time updates**: Payment status webhooks → <a href="/payments/billpay/api-integration/webhooks" target="_blank">Webhooks Integration</a>
