...
The dispute request api now supports the below dispute types <a href='/payments/billpay/api-integration/api-reference#/category~Dispute/operation~DisputeRequest'>See API Reference</a>.
...
The dispute response api now supports the below status values and new fields <a href='/payments/billpay/api-integration/api-reference#/category~Dispute/operation~DisputeResponse'>See API Reference</a>.
