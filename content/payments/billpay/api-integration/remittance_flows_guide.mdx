...
The payment event webhook has been enhanced to include remitter details under the `remitter` object and account information within the `accountInfo` property.
...
The payment status API has been enhanced to include remitter details under the `remitter` object and account information within the `accountInfo` property.
