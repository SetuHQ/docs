...
<ul>
    ...
    <li>
        <a
            target="_blank"
            href="/payments/billpay/api-integration/api-reference#/category~List/path~/api/v2/bbps/transactions/get"
        >
            List paid bills
        </a>
        —lists all the bill pay transactions paid using <a
            target="_blank"
            href="/payments/billpay/api-integration/api-reference#/category~Pay/path~/api/v2/bbps/bills/payment/request/post"
        >
            Pay API
        </a>.
    </li>
