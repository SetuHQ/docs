...
The <a href="/payments/billpay/api-integration/api-reference#/category~Pay/path~/api/v2/bbps/bills/payment/request/post" target="_blank">Pay bill API</a> is used to send details of a payment done by a user on your app/website to Setu. Setu uses this information to confirm a payment with the biller.
...
The <a href="/payments/billpay/api-integration/api-reference#/category~Dispute/path~/api/v2/bbps/bills/complaint/request/post" target="_blank">Raise Dispute API</a> is used to Raise a compliant for a payment done by a user on your app/website to Setu. Setu uses this information and raises a compliant on the BBPS Platform.
...
<ul>
    ...
    <li>
        ...
        <ul>
            ...
            <li><code>valAddCustParams</code> (<code>ValAddCustParamSpec[]</code>) — customer parameters required for value-added service flows. Each entry includes <code>requestType</code> (e.g. <code>MANDATE_AND_PAY</code> for FX Retail mandate+pay) and the corresponding <code>customerParams</code> specs.</li>
    ...
    <li>
        ...
        —lists all the raised disputes using the <a target="_blank" href="/payments/billpay/api-integration/api-reference#/category~Dispute/path~/api/v2/bbps/bills/complaint/request/post">Dispute API</a>.
    </li>
</ul>
