---
sidebar_title: Plans
page_title: When Users Need to Select Plans Before Payment
order: 9
...
### Common Services That Need Plans
...
### Pattern 2: Get Personalized Options
...
## Pattern 1: Full Catalog Selection
...
### Step 3: Validate Account + Selected Plan
...
POST /api/v2/bbps/bills/fetch/request
{
  ...
  "customer": {
    "mobile": "9999999999",
    "customerParams": [
      { "name": "Id", "value": "3" },              // Plan ID from Step 1
...
## Pattern 2: Personalized Options
...
### Step 1: Validate Account (Without Plan Selection)
...
### Step 2: Get Personalized Plans from Validation Response
...
### Step 3: Process Payment with Selected Plan
