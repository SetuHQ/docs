...
<Card padding="nano" shape="rounded">
    ...
    "error": {
        "Code": "biller-registration-failed", // Note: PascalCase field name
        "Message": "Failed to register with Biller" // Note: PascalCase field name
    },
...
<Card padding="nano" shape="rounded">
    ...
    "error": {
        "Code": "biller-update-registration-failed", // Note: PascalCase field name
        "Message": "Failed to update registration with Biller" // Note: PascalCase field name
    }
}`}
        </CodeBlockWithCopy>
    </details>
...
<Card padding="nano" shape="rounded">
    ...
    "error": {
        "Code": "registration-cancellation-failed", // Example Error Code; Note: PascalCase
        "Message": "Failed to cancel registration with Biller" // Example Error Message; Note: PascalCase
    }
}`}
        </CodeBlockWithCopy>
    </details>
