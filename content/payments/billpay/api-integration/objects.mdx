...
| `os`         | `iOS \| Android` | Initiating device OS           |
...
| type      | `FUND_TRANSFER \| BBPS \| APP` | Error Type. BBPS errors are due to BBPS, and code and message field contain the actual BBPS error. |
