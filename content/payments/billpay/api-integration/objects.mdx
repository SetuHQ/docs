...
The Bill object contains information about a specific bill to be paid.
...
| bills                | [Bill[]](#bill)                           | Details of bills paid                |
...
| bill                | [Bill Data](#bill-data)                         | Single bill data. Used when `billerResponseType` is 'SINGLE'.                             |
| bills               | [Bill Data](#bill-data)`[]`                     | Array of bill data. Used when `billerResponseType` is 'LIST'.                             |
...
| bills          | [Bill[]](#bill)                     | Details of bills to be paid. Mandatory for LIST billers only.                         |
...
| bills          | [Bill[]](#bill)                     | Details of bills paid. Present for LIST billers only.           |
