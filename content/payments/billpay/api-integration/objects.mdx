...
| parameter  | type                      | description                                                      |
|------------|---------------------------|------------------------------------------------------------------|
| dataType   | `NUMERIC \| ALPHANUMERIC` | Value format                                                     |
| maxLength  | `integer \| null`         | Value's max length                                               |
| minLength  | `integer \| null`         | Value's min length                                               |
...
| minLimit              | `integer \| null`                   | Minimum acceptable amount in paise                         |
| maxLimit              | `integer \| null`                   | Maximum acceptable amount in paise                         |
...
| status          | `ACTIVE \| DEACTIVE` | Plan status                              |
