...
<p>
  ...
  if needed. Contact us at <a href="">billpay.support@setu.co</a>, should you
...
<Callout type="highlight">
  Look at the{" "}
  <a href="/payments/billpay/pre-built-screens/quickstart/api/polling" target="_blank">
    polling mechanism
  </a>{" "}
...
<p>
  Here is a{" "}
  <a
    href="https://billpay.setu.co/cou/categories/91de2627-b66e-49f6-afba-0285c8da9b0a"
    target="_blank"
  >
