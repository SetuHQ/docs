...
1. <a
       href="/payments/billpay/api-reference/white-label#/category~Link/operation~getLink"
       target="_blank"
   >
       Create one time link
   </a>
2. <a
       href="/payments/billpay/api-reference/white-label#/category~Payment/operation~paymentWebhook"
       target="_blank"
   >
       Confirm payment
   </a>{" "}
