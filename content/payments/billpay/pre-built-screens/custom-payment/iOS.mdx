...
The `data` object (for the `initiate_payment` function) contains the payment parameters. Your app's `userContentController` method can access these fields directly from this `data` dictionary.
