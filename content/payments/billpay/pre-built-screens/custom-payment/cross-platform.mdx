                            ...
                            ? InAppWebView(
                                ...
                                onLoadStop: (controller, url) async {
                                    controller.addJavaScriptHandler(
                                        ...
                                        callback: (args) async {
                                            // args[0] contains the paymentDetails object directly
                                            print('Received payment data object from WebView: ${args[0]}');
                                            
                                            // Your app can access the fields directly from args[0] (which is typically a Map)
                                            // Example:
                                            // final paymentDetails = args[0] as Map<String, dynamic>;
                                            // String orderId = paymentDetails['orderId'];
                                            // String amount = paymentDetails['amount'];
                                            // String postPaymentUrl = paymentDetails['postPaymentUrl'];
                                            // String customerMobileNumber = paymentDetails['customerMobileNumber'];
                                            // String customerId = paymentDetails['customerId']; // Optional
                                            // String allowedPaymentModes = paymentDetails['allowedPaymentModes']; // Optional
                                            
                                            // Add your custom payment logic here using the parsed details
                                            // For demonstration, we'll just print the received object:
                                            print('Payment data object: ${args[0]}');
                                        },
                                    );
                                    controller.addJavaScriptHandler(
                                        handlerName: 'unload',
