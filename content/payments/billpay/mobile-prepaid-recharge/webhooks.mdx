...
| `amount` | string | Recharge amount | Yes |
...
| `balance` | string | Current wallet balance amount | Yes |
...
| `amount` | string | Top-up amount credited to wallet | Yes |
...
| `traceId` | string | Unique trace ID for this notification | Yes |
| `currentBalance` | string | Current wallet balance after the top-up | Yes |
