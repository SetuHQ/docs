...
page_title: UPI Setu - Merchant onboarding
order: 2
...
<br />
<a href="/payments/umap/api-integration/aggregators" target="_self">
  🌟 Start API integration for aggregators ↗
</a>
...
<a href="/payments/umap/merchant-onboarding/create-merchant-api" target="_self">
  Create merchant API ↗
</a>
...
<Text size="small">
  <a href="/payments/umap/merchant-onboarding/create-vpa-api" target="_self">
    Create VPA API ↗
  </a>
</Text>
  ...
  <Portion desktopSpan="half">
    <Link href="/payments/umap/api-integration/merchants">
      <Card padding="micro" shape="rounded">
        ...
        <Text weight="400">Enable recurring payments with UPI Mandates</Text>
      </Card>
    </Link>
  </Portion>
</Row>
