...
You can use the following API, to on-board merchants in UMAP, by providing business details and your `aggregatorID`.

<Callout type='tip'>For merchants acquired directly, `aggregatorID` can be accessed from Bridge</Callout>
<br/>
