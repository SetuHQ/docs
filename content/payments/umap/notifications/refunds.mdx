...
<Text>
  <ul>
    <li>
<<<<<<< HEAD
      <code>refund.initiated</code>&nbsp;Refund request has been create at UPI
      Setu
=======
      <code>refund.initiated</code>&nbsp;Refund request has been create at UMAP
>>>>>>> a114582 (Add signature verification docs)
    </li>
    <li>
      <code>refund.pending</code>&nbsp;Refund is in queue to be processed
    </li>
    <li>
      <code>refund.successful</code>&nbsp;Refund has been successfully completed
    </li>
    <li>
      <code>refund.failed</code>&nbsp;Refund could not be processed
    </li>
  </ul>
</Text>
