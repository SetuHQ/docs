...
<<<<<<< HEAD
page_title: UPI Setu - Notifications and alerts - Mandates
order: 2
=======
...
<Text>
  <ul>
    <li>
      <code>mandate.initiated</code> A customer or merchant has initiated
      creation of mandate
    </li>
    <li>
    ...
    <li>
      ...
      error or due to the customer not authorising the mandate
    </li>
    <li>
    ...
    <li>
      ...
      from this customer would need a new mandate to be set up
    </li>
    <li>
      <code>mandate.complete</code> All mandate executions are complete
    </li>
  </ul>
</Text>
