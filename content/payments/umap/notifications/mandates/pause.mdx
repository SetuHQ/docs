---
sidebar_title: Pause
page_title: UMAP - Notifications and alerts - Pausing mandate
order: 4
...
<a href="/payments/umap/mandates/generic/pause" target="_self">🌟 UPI mandate pause ↗</a>
            ...
            content: (
                <>
                    <Text>
                        ...
                        <ul>
                            <li><code>operation</code> will be <code>pause</code></li>
                            <li><code>eventType</code> will be <code>mandate_operation.pause.initiated</code></li>
            ...
            content: (
                <>
                    <Text>
                        ...
                        <ul>
                            <li><code>operation</code> will be <code>pause</code></li>
                            <li><code>eventType</code> will be <code>mandate_operation.pause.success</code></li>
            ...
            content: (
                <>
                    <Text>
                        ...
                        <ul>
                            <li><code>operation</code> will be <code>pause</code></li>
                            <li><code>eventType</code> will be <code>mandate_operation.pause.failed</code></li>
