...
<a href="/payments/umap/mandates/generic/revoke">🌟 UPI mandate revoke ↗</a>

<hr class="primary" />

These are the available webhooks for merchants, when revoking of mandate is done by either the customer or in rarer cases, the merchant.
            ...
            content: (
                <>
                    <Text>
                        ...
                        <ul>
                            <li><code>operation</code> will be <code>revoke</code></li>
                            <li><code>eventType</code> will be <code>mandate_operation.revoke.initiated</code></li>
            ...
            content: (
                <>
                    <Text>
                        ...
                        <ul>
                            <li><code>operation</code> will be <code>revoke</code></li>
                            <li><code>eventType</code> will be <code>mandate_operation.revoke.success</code></li>
            ...
            content: (
                <>
                    <Text>
                        ...
                        <ul>
                            <li><code>operation</code> will be <code>revoke</code></li>
                            <li><code>eventType</code> will be <code>mandate_operation.revoke.failed</code></li>
