...
<img
  src="https://docs-mdx-assets-sandbox.s3.ap-south-1.amazonaws.com/latest/mandate_update/mandate_update.svg"
  alt="Bridge"
/>
...
<Tabs
  ...
  // This is a pseudo status. Do not update mandate status based on this. This is just an
  // alternative for merchants that do not subscribe to mandate_operation events
  "status": "updated",                                                                            
  "reason": {
