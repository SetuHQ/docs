...
page_title: UMAP - Notifications and alerts - Mandate execution
order: 7
...
These are the available webhooks for merchants, when they execute mandates being registered through UMAP.
