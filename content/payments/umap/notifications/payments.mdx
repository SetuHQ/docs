...
<table>
  ...
  <tr>
    <td>
      <code>payment.initiated</code>
    </td>
    <td>
      Payment has been attempted by a customer — when a customer tries to make a
      payment by scanning a QR or clicking on a shortlink and entering his UPI
      pin on a Payer PSP{" "}
    </td>
  </tr>
  <tr>
    ...
    <td>
      Payment is currently being processed — when the UPI network takes a while
      to process the payment or when the beneficiary bank is down
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td>
      Payment has been successfully completed — when all participants involved
      in the payment have acknowledged and accepted the payment
    </td>
  </tr>
  <tr>
    <td>
    ...
    <td>
      Payment could not be processed, you can find more about why it failed with
      the <code>reason</code> object in the notification payload
    </td>
  </tr>
</table>
