...
<p>In addition to the notifications, the merchant can also use <Link href="/payments/umap/mandates/otm/execute#check-mandate-execution-status">check mandate execution status API</Link> to check if execution is <b>successful</b></p>
