...
page_title: UMAP - Mandates - Execute One Time Mandate
order: 3
...
<Card padding="nano" shape="rounded" marginBottom="micro" marginTop="micro">
    ...
    <a href="/payments/umap/mandates/otm/pre-debit-notify">
        Pre-debit notification ↗
    </a>
</Card>

<br />
Once the mandate pre debit notification is **successful**, the merchant can execute
the mandate on the `executionDate` mentioned while sending the pre debit notification.
...
<p>
    <b>Request body parameter values for executing a one time mandate</b>
</p>
<table>
    <tr>
        <th>parameter</th>
...
<p>
    ...
    <Link href="/payments/umap/mandates/otm/execute#check-mandate-execution-status">
...
<NextPage
    info={{
        ...
        slug: "/payments/umap/mandates/otm/check-status",
