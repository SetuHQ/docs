...
<Card padding="small" shape="rounded">
    <a href="/payments/umap/mandates/otm/pre-debit-notify" target="_blank">
...
<p><b>Request body parameter values for executing a one time mandate</b></p>
<table>
    <tr>
        <th>parameter</th>
        <th>value</th>
...
<p>In addition to the notifications, the merchant can also use <a href="/payments/umap/mandates/otm/execute#check-mandate-execution-status" target="_blank">check mandate execution status API</a> to check if execution is <b>successful</b></p>
