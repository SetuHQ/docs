...
page_title: UMAP - Mandates - Intent Based One Time Mandate
order: 1
visible_in_sidebar: true
---

## Intent Based One Time Mandate
...
#### Create One Time Mandate via Intent API
...
#### Update One Time Mandate via Intent API
