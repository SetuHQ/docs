...
page_title: UPI Setu - Mandates - Create Reserve Mandate
order: 1
visible_in_sidebar: true
---

## Create reserve mandate

There are two ways to create a Reserve mandate—**Intent based** and **Collect based**
...
<ul>
  ...
  <li>
    ...
    mandate and is needed for execution APIs.
  </li>
</ul>
...
<NextPage
  info={{
    description: "Execute the mandate",
    slug: "/payments/umap/mandates/reserve/execute",
