  ...
  tabs={[
    {
      ...
      content: (
        <Text>
          ...
          <img
            src="https://docs-assets.setu.co/latest/intent-mandate-creation/intent-mandate-creation.png"
            alt="Bridge"
          />
          <hr class="primary" />
          <p>
    ...
    },
    {
      ...
      content: (
        <Text>
          ...
          <img
            src="https://docs-assets.setu.co/latest/collect-mandate-creation/collect-mandate-creation.png"
            alt="Bridge"
          />
          <p>
            The merchant will have to call the{" "}
