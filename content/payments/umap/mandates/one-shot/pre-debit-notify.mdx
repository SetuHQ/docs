...
page_title: UPI Setu - Mandates - Send One Time Mandate Pre Debit Notification
order: 2
...
<img
  src="https://docs-assets.setu.co/latest/update-mandate-pre-debit-notification/update-mandate-pre-debit-notification.png"
  alt="Bridge"
/>
...
<p>
  ...
  <a href="/payments/umap/api-reference#/category~mandates/operation~mandates#fetchMandatePreDebitNotificationById" target="_blank">here</a>
  .
</p>
