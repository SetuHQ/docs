...
page_title: UPI Setu - Mandates - Execute One Time Mandate
order: 3
...
<a href="/payments/umap/mandates/one-shot/pre-debit-notify" target="_self">
...
<NextPage
  info={{
    ...
    slug: "/payments/umap/mandates/one-shot/check-status",
