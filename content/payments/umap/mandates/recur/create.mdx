  ...
  tabs={[
    {
      ...
      content: (
        <Text>
          ...
          <img
            src="https://docs-mdx-assets-sandbox.s3.ap-south-1.amazonaws.com/latest/intent-mandate-creation/intent-mandate-creation.png"
            alt="Bridge"
          />
          <hr class="primary" />
          <p>
                        ...
                        <table>
                          <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                <img
                                  src="https://docs-mdx-assets-sandbox.s3.ap-south-1.amazonaws.com/latest/Weekly_Recurrence/Weekly_Recurrence.png"
                                  alt="Bridge"
                                />
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td>
                                <img
                                  src="https://docs-mdx-assets-sandbox.s3.ap-south-1.amazonaws.com/latest/Fortnightly_Recurrence/Fortnightly_Recurrence.png"
                                  alt="Bridge"
                                />
                              </td>
                            </tr>
                            <tr>
                              ...
                              <td>
                                <img
                                  src="https://docs-mdx-assets-sandbox.s3.ap-south-1.amazonaws.com/latest/Monthly_and_Above_Recurrence/Monthly_and_Above_Recurrence.png"
                                  alt="Bridge"
                                />
                              </td>
                            </tr>
    ...
    "txnId": "BTTZrc5gDFkuCr3n3I0ey4aNtzLOLR7K7aR"
          ...
          <ul>
            <li>
              <b>mandate.initiated</b> (if no validation errors are encountered on UPI Setu during mandate creation)
            </li>
            <li>
            ...
            <li>
              <b>mandate.rejected</b> (if mandate creation fails due to mandate intent / qr expiry)
            </li>
            <li>
    ...
    },
    {
      ...
      content: (
        <Text>
          ...
          <img
            src="https://docs-mdx-assets-sandbox.s3.ap-south-1.amazonaws.com/latest/collect-mandate-creation/collect-mandate-creation.png"
            alt="Bridge"
          />
          <p>
            The merchant will have to call the{" "}
