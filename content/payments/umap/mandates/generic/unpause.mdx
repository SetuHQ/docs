  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        &gt;. Generate this token using <a href="/payments/umap/api-integration" target="_blank">OAuth</a>
        .<br />
        <br />
...
<p>
  ...
  <a href="/payments/umap/api-reference#/category~mandates/operation~mandates#fetchMandateOperationById" target="_blank">here</a>
  .
</p>
