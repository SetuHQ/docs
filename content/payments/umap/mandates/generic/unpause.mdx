...
<p>After receiving <b>mandate_operation.unpause.initiated</b> notification, the merchant can also use <Link href="/payments/umap/mandates/generic/unpause#check-mandate-operation-status">check mandate operation status API</Link> to check if mandate unpause is <b>successful</b></p>
