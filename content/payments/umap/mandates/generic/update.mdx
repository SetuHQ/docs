  ...
  tabs={[
    {
      ...
      content: (
        <Text>
          ...
          below diagram
          <img
            src="https://docs-mdx-assets-sandbox.s3.ap-south-1.amazonaws.com/latest/intent-mandate-updation/intent-mandate-updation.png"
            alt="Bridge"
          />
    ...
    },
    {
      ...
      content: (
        <Text>
          ...
          below diagram
          <img
            src="https://docs-mdx-assets-sandbox.s3.ap-south-1.amazonaws.com/latest/collect-mandate-updation/collect-mandate-updation.png"
            alt="Bridge"
          />
          The merchant will have to call the{" "}
          <b>
