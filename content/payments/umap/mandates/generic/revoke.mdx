        ...
        },
        {
            ...
            content: (
                <Text>
                    ...
                    <ul>
                        <li>
                            <b>mandate_operation.revoke.initiated</b>
                        </li>
                        <li>
                            <b>mandate.revoked</b> (if mandate revoke is
                            successful)
                    ...
                    <p>
                        After receiving{" "}
                        <b>mandate_operation.revoke.initiated</b> notification,,
                    ...
                    Please refer to the Document Reference section for checking the
                    API reference and the notifications. <br></br>
                    <Callout type="warning">
                        A <code>single block multi debit mandate</code> can only
                        be revoked via{" "}
                        <code>merchant initiated collect flow</code> and not via{" "}
                        <code>customer initiated flow</code>
                    </Callout>
                </Text>
            ),
        },
