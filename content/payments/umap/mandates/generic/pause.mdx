...
<Callout type="tip">
                Only customers can pause a UPI mandate from their UPI app and there is no merchant intervention required.
            </Callout>
<br/>
...
<p>After receiving <b>mandate_operation.pause.initiated</b> notification, the merchant can also use <Link href="/payments/umap/mandates/generic/pause#check-mandate-operation-status">check mandate operation status API</Link> to check if mandate pause is <b>successful</b></p>
