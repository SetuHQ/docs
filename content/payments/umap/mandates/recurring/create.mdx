...
<Tabs
  tabs={[
    ...
    "txnId": "BTTZrc5gDFkuCr3n3I0ey4aNtzLOLR7K7aR"
            ...
            <p>In addition to the notifications, the merchant can also use <Link href="/payments/umap/mandates/recurring/create#check-mandate-status">check mandate status API</Link> to check if mandate is <b>LIVE</b></p>
