...
<Card padding="nano" shape="rounded" marginBottom="micro">
    <Text size="medium" marginBottom="none" paddingRight="medium">
        ...
        <Link href="/payments/umap/mandates/recurring/create">
...
<p><b>Request body parameter values for sending pre debit notification for a recurring mandate</b></p>
<table>
    <tr>
        <th>parameter</th>
        <th>value</th>
...
<p>In addition to the notifications, the merchant can also use <a href="/payments/umap/mandates/recurring/pre-debit-notify#check-mandate-pre-debit-notification-status" target="_blank">check mandate pre debit notification status API</a> to check if pre debit notification is <b>successful</b></p>
