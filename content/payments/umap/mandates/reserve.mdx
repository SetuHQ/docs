...
<Callout type="tip"><strong>Merchant</strong> does not have to send any pre-debit notification as customer allowing blocking of funds is equivalent to giving consent for transaction.</Callout>
