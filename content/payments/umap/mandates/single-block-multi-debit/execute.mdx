...
<Card padding="nano" shape="rounded" marginBottom="micro">
    <Text size="medium" marginBottom="none" paddingRight="medium">
        ...
        <Link href="/payments/umap/mandates/single-block-multi-debit/create">
...
<p>In addition to the notifications, the merchant can also use <Link href="/payments/umap/mandates/single-block-multi-debit/execute#check-mandate-execution-status">check mandate execution status API</Link> to check if execution is <b>successful</b></p>
