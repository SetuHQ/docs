...
<p>In addition to the notifications, the merchant can also use <Link href="/payments/umap/mandates/single-block-multi-debit/create#check-mandate-status">check mandate status API</Link> to check if mandate is <b>LIVE</b></p>
