...
page_title: UMAP - Mandates - Intent Based Single Block Multi Debit Mandate Creation
order: 1
visible_in_sidebar: true
---

## Intent Based Single Block Multi Debit Mandate Creation
...
### Create Single Block Multi Debit Mandate via Intent API
