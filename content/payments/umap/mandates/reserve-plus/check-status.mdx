...
<a href="/payments/umap/mandates/reserve-plus/execute" target="_self">
  🌟 Execute mandate ↗
</a>
...
<Tabs
  tabs={[
    ...
    "txnNote": "testpay"
          ...
          <ul>
            <li>
              <code>id</code> is a unique ID that is associated with this
              mandate payment and can be used to track it later.
            </li>
          </ul>
          <p>
