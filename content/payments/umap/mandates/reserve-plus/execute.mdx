...
page_title: UPI Setu - Mandates - Execute single block multi-debit
order: 2
...
<a href="/payments/umap/mandates/reserve-plus/create" target="_self">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <br />
        <code>Authorization</code>: Bearer &lt;<b>insert_token_here</b>&gt;. Generate this token using <a href="/payments/umap/api-integration" target="_blank">OAuth</a>.<br />
        <br />
...
<p>
  ...
  <Link href="/payments/umap/mandates/reserve-plus/execute#check-mandate-execution-status">
