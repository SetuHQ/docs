...
page_title: UMAP - Mandates - Execute single block multi-debit
order: 2
...
<a href="/payments/umap/mandates/single-block-multi-debit/create" target="_self">🌟 Create single block multi debit mandate ↗</a>
