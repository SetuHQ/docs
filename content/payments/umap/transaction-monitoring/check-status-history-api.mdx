---
sidebar_title: Check Status History API
page_title: UMAP - Transaction Monitoring - Check Status History API
order: 2
...
<table>
    <tbody>
        ...
        <tr>
            <th>Path</th>
            <td>
                <code>/merchants/payments/product-instances/{id}/history</code>
            </td>
        </tr>
        <tr>
            <th>Header</th>
