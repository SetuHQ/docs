...
<Tabs
  ...
  "transactionNote": "testpay"
        ...
        <Element as="ul">
        <li><code>amount</code> is a mandatory field.</li>
        <li><code>productConfigId</code> is an optional field.</li>
        </Element>
        <Callout type="note">
            By creating a payment link with paymentType as <code>pay_single</code>
  ...
  "transactionNote": "testpay"
          ...
          <Element as="ul">
            <li><code>amount</code> is an optional field.</li>
            <li><code>productConfigId</code> is an optional field.</li>
        </Element>
        <Callout type="note">
            By creating a payment link with paymentType as <code>pay_multi</code>
...
<Callout type='tip'>This API fetches status of the payment-link itself, not the payment done using it </Callout>
<br/>
<p>The merchant can also get the payment link status by payment link id by calling <b><i>check payment link status API</i></b> which can be used for debugging or knowing if payment link is active, inactive or expired.</p>
<br/>
<table>
    <tbody>
         <tr>
