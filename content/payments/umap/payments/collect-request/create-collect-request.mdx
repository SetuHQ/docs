...
page_title: UMAP - Payments - Create Collect Request
order: 2
...
<NextPage
    info={{
        description:
            "Check payment status associated with collect request.",
        slug: "/payments/umap/payments/collect-request/check-status",
