...
<p>This gives a merchant an information about the <b><i>customer vpa, payment mode</i></b> which helps the merchant to decide whether to initiate the collect request or not.</p>
