---
sidebar_title: Static QR
page_title: UPI Setu payments - Create Static QR
order: 1
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        <a
          href="/payments/umap/api-reference#/category~payment-link/operation~sqr#fetchById"
          target="_blank"
        >
          Fetch dqr by id ↗
        </a>
      ...
      content: (
        <>
          <CodeBlockWithCopy language="bash">
            {`curl --request GET \
  --url https://umap-uat-core.setu.co/api/v1/merchants/sqr/01ARZ3NDEKTSV4RRFFQ69G5FAV \
