...
<p>
  ...
  <b>
    <i>check status API</i>
  </b>{" "}
  to check the payment status, for third party verification
</p>
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>
        <code>
          /v1/merchants/payments/product-instances/&#123;tpvId&#125;/last
        </code>
      </td>
    </tr>
    <tr>
...
<Callout type='tip'>This API can be useful to check the payments done on the payment-link that accept <strong>multiple payments</strong>. </Callout>
...
<table>
    <tbody>
        ...
        <tr>
            <th>Path</th>
            <td>
                <code>/v1/merchants/payments/product-instances/&#123;paymentLinkId&#125;/history</code>
            </td>
        </tr>
        <tr>
            <th>Header</th>
        ...
        <tr>
            <th>API reference</th>
            <td>
                <a href="/payments/umap/api-reference#/category~payments/operation~payments#fetchHistoryByProductInstanceId" target="_blank">
                    Check Payment History ↗
                </a>
            </td>
        </tr>
