...
-   `authorisation` - Bearer <code>`insert_token_here`</code>. This token can be generated via the **Generate Access Token API**
...
<Row>
    ...
    <Portion desktopSpan="half">
        <Card padding="small" shape="rounded">
            ...
            <p>For Merchants</p>
            <a href="/payments/umap/api-integration/merchants" target="_self">
                Start API integration ->
            </a>
        </Card>
    </Portion>
