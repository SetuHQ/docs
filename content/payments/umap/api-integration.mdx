...
<p>
    Once you get the <code>clientID</code> and <code>secret</code> from Setu,
    use them to generate the token.
</p>
...
<Callout type="tip">
    💡 The <code>access_token</code> is valid for 5 minutes.
</Callout>
...
<Callout type="tip">
    💡 <strong>After expiry</strong>, use the <code>Generate Access Token</code>{" "}
...
<Row>
    <Portion desktopSpan="half">
        <Card padding="small" shape="rounded">
            ...
            <p>Start integrating as a merchant to start accepting payments over UPI.</p>
        </Card>
    </Portion>
    <Portion desktopSpan="half">
        <Card padding="small" shape="rounded">
            ...
            <p>Start integrating as an aggregator, to on-board and manage multiple merchants.</p>
        </Card>
    </Portion>
</Row>
