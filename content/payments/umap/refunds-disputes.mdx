...
<img
  src="https://docs-mdx-assets-sandbox.s3.ap-south-1.amazonaws.com/latest/refund-flow-online_flow/refund-flow-online_flow.png"
  alt="Bridge"
/>
...
- `refund_successful` Refund has been
  ...
  <img
    src="https://docs-mdx-assets-sandbox.s3.ap-south-1.amazonaws.com/latest/Frame_74/Frame_74.png"
    alt="Bridge"
  />
  <NextPage
    info={{
