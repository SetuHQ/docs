...
<Callout type="tip">
  ...
  <a href="/dev-tools/bridge/org-settings/api-keys/oauth#generate-token-api" target="_blank">OAuth token generation API</a><br/>
</Callout>
<br/>
<Callout type="tip">
  To obtain <code>x-setu-client-id</code>, decode the <code>token</code> obtained from {" "}
  <a href="/dev-tools/bridge/org-settings/api-keys/oauth#generate-token-api" target="_blank">OAuth token generation API</a> and find the value of<code>X-Setu-Client-ID</code> in the decoded <code>token</code>
</Callout>
<br/>
