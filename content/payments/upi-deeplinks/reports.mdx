...
page_title: UPI Deeplinks Reports API
order: 5
...
Setu Reports API provides you access to transaction and settlement data. This can be consumed to automate your reconcilliation process.
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <br />
        <br />
        <code>x-setu-env</code>: <code>Test</code>/ <code>Live</code>. This
        corresponds to the Sandbox and Production environment on The Bridge.
        <br />
        <br />
        <code>Authorization</code>: Bearer (<b>insert_token_here</b>). Generate this
        token using <a href="/payments/upi-deeplinks/resources/oauth" target="_blank">OAuth
        </a> or <a href="/payments/upi-deeplinks/resources/jwt" target="_blank">JWT
        </a>.
        <br />
      </td>
    </tr>
