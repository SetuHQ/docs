...
For a more exhaustive list of failure cases and the corresponding NPCI status code <a href="/payments/upi-deeplinks/failure-notifications" target="_blank">click here</a>
