...
- `iat`  is the epoch timestamp in seconds, at which the request was issued. Requests older than 60 seconds (1 minute) are considered stale, and hence must be rejected.
