...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="/payments/upi-deeplinks/resources/oauth" target="_blank">OAuth</a>{" "}
                or{" "}
                <a href="/payments/upi-deeplinks/resources/jwt" target="_blank">JWT</a>
            </td>
            <td>
                <a href="/payments/upi-deeplinks/api-reference#/category~APIs_to_call/operation~paymentLink" target="_blank">Read</a>
            </td>
        </tr>
        <tr>
            <td>Add credit</td>
            ...
            <td>
                <a href="/payments/upi-deeplinks/api-reference#/category~Testing_integration/operation~addCredit" target="_blank">Read</a>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <a href="/payments/upi-deeplinks/api-reference#/category~Notifications/operation~notification" target="_blank">Read</a>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <a href="/payments/upi-deeplinks/api-reference#/category~APIs_to_call/operation~paymentStatus" target="_blank">Read</a>
            </td>
        </tr>
        <tr>
            <td>Expire bill</td>
            ...
            <td>
                <a href="/payments/upi-deeplinks/api-reference#/category~APIs_to_call/operation~expireBill" target="_blank">Read</a>
            </td>
        </tr>
        <tr>
            <td>Create refund</td>
            ...
            <td>
                <a href="/payments/upi-deeplinks/api-reference#/category~APIs_to_call/operation~initiateBatchRefund" target="_blank">Read</a>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <a href="/payments/upi-deeplinks/api-reference#/category~APIs_to_call/operation~getRefundsBatchStatus" target="_blank">Batch refund</a>
                ,
                <br />
                <br />
                <a href="/payments/upi-deeplinks/api-reference#/category~APIs_to_call/operation~getRefundStatus" target="_blank">Individual refund</a>
            </td>
        </tr>
    </tbody>
</table>
...
Set up authentication details as per your preference to expose `callbackURL`. Add details on The Bridge and <a href="https://setu.co/support" targrt="_blank">contact Setu's team</a>, if needed. Note that you can also add multiple callback URLs, as per your requirements.
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                Generate this token using <a href="/payments/upi-deeplinks/resources/oauth" target="_blank">OAuth</a> or <a href="/payments/upi-deeplinks/resources/jwt" target="_blank">JWT</a>.<br />
                <br />
        ...
        <tr>
            ...
            <td>
                ...
                The request should simply be the API URL with <code>
                    ...
                    <c>platformBillId</c>&gt;
                </code>. <a href="api-reference#/category~APIs_to_call/operation~paymentStatus" target="_blank">Read more</a>.
            </td>
        </tr>
        <tr>
            <th>Header</th>
            <td>
                ...
                <br />
                <code>Authorization</code>: Bearer &lt;<b>insert_token_here</b>&gt;.
                Generate this token using <a href="/payments/upi-deeplinks/resources/oauth" target="_blank">OAuth</a> or <a href="/payments/upi-deeplinks/resources/jwt" target="_blank">JWT</a>.
            </td>
        </tr>
    </tbody>
</table>
