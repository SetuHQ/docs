...
- `X-Setu-Product-Instance-ID`—this is a unique identifier for your merchant configuration set up on the Bridge. Look for the “Merchant ID” on the top left, inside your merchant configuration.
  ![](https://docs-assets.setu.co/latest/Image_For_Merchant_ID_5a5c68ba56/Image_For_Merchant_ID_5a5c68ba56.png)
...
<Callout type="warning">
  Please note, Setu will add <code>/notifications</code> at the end of this URL.
</Callout>
...
<Callout type="warning">
  ...
  approval from a Setu admin. Until approved, the changes will not be made live.
  This maker-checker process exists to ensure that there are no accidental
  updates to the configurations of live products.
</Callout>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <br />
        <br />
        The request should simply be the API URL with{" "}
        <code>platformBillID</code> appended to the path appropriately{" "}
        <code>
  ...
  <table>
    <tbody>
      ...
      <tr>
        ...
        <td>
          User has made a payment but it failed due to some validation reasons
          or bank side issue (rare scenario).
        </td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td>
          The attempt to settle money to merchant account has failed - generally
          we would either resolve this internally with next batch of settlement
          or reach out to you in case there is some additional info required.
        </td>
      </tr>
      <tr>
        <td>BILL_EXPIRED</td>
        <td>
          The UPI link has expired either by the default timeline or the
          timeline set by customer.
        </td>
      </tr>
    </tbody>
  </table>
