...
<MainImage
    src="https://docs-assets.setu.co/latest/BBPS_Bill_fetch_cycle_2x_7e9d96b929/BBPS_Bill_fetch_cycle_2x_7e9d96b929.png"
...
<MainImage
    src="https://docs-assets.setu.co/latest/BBPS_Payment_cycle_2x_3d58b5d3d3/BBPS_Payment_cycle_2x_3d58b5d3d3.png"
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <br />
                <br />
                <code>Authorization</code>: Bearer (<b>insert_token_here</b>). Read about how to generate this token <a href="resources/generate-token" target="_blank">here</a>.
            </td>
        </tr>
    </tbody>
</table>
