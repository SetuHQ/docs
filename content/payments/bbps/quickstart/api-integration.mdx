...
<MainImage
    src="https://docs-assets.setu.co/latest/biller_create_def9d37373/biller_create_def9d37373.gif"
    alt="Create a biller"
/>
...
<MainImage
    src="https://docs-assets.setu.co/latest/biller_dashboard_4da36b3b41/biller_dashboard_4da36b3b41.png"
...
<MainImage
    src="https://docs-assets.setu.co/latest/biller_config_8633de64a3/biller_config_8633de64a3.png"
...
-   <a href="/payments/bbps/api-reference#/category~APIs_to_Implement/operation~fetchCustomerBills" target="_blank"><code>fetchCustomerBills</code> ↗</a> used to share a customer's bill(s) with the BBPS system
-   <a href="/payments/bbps/api-reference#/category~APIs_to_Implement/operation~fetchBillReceipt" target="_blank"><code>fetchBillReceipt</code> ↗</a> used to generate and access a receipt against a customer's payment
...
<MainImage
    src="https://docs-assets.setu.co/latest/biller_url_config_836bfdc83a/biller_url_config_836bfdc83a.png"
...
<MainImage
    src="https://docs-assets.setu.co/latest/biller_settlement_account_5bd1fc37f5/biller_settlement_account_5bd1fc37f5.png"
